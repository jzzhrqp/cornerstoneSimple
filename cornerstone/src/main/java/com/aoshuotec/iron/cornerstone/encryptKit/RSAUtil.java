...
public class RSAUtil {
    ...
    public static byte[] encryptData(byte[] data, PublicKey publicKey)
    {
        try
        {
            Cipher cipher = Cipher.getInstance(RSA_CONFIGURATION);
            // 编码前设定编码方式及密钥
    ...
    public static PublicKey getPublicKey(String base64modulus) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeySpecException {
        BigInteger modulus = new BigInteger(1,Base64Util.decode(base64modulus));
