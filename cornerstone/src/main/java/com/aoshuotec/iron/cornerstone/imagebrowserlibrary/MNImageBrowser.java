package com.aoshuotec.iron.cornerstone.imagebrowserlibrary;
...
import imagebrowserlibrary.MNImageBrowserActivity;
...
public class MNImageBrowser {
    ...
    public static void showImageBrowser(Context context, View view, int position, int viewPagerTransformType, ArrayList<String> imageList) {
        ...
        intent.putExtra(MNImageBrowserActivity.Companion.getIntentKey_ImageList(), imageList);
        intent.putExtra(MNImageBrowserActivity.Companion.getIntentKey_CurrentPosition(), position);
        intent.putExtra(MNImageBrowserActivity.Companion.getIntentKey_ViewPagerTransformType(), viewPagerTransformType);
